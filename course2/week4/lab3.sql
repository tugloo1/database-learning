...
--  (Hint: Use an IF function to determine which format to use.).  This column should be aliased as formatted_number
...
SELECT
    ...
    CASE LENGTH(card_number)
		WHEN 16 THEN CONCAT('XXXX-XXXX-XXXX-', RIGHT(card_number, 4))
        WHEN 15 THEN CONCAT('XXXX-XXXXXX-X', RIGHT(card_number, 4))
